...
sys.path.append(r'E:\GAL\Graph-Anomaly-Loss-master')
...
parser.add_argument('--config_dir', type=str, default='E:\GAL\Graph-Anomaly-Loss-master/configs')      #改变路径到上级文件夹          ###!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
parser.add_argument('--logs_dir', type=str, default='./logs')
parser.add_argument('--out_dir', default='E:\GAL\Graph-Anomaly-Loss-master/results')                                                 ####!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
parser.add_argument('--a_loss', type=str, default='none')           #根据数据名称进行更换
parser.add_argument('--unsup_loss', type=str, default='normal')     ##未找到使用位置
...
parser.add_argument('--cluster_aloss', action='store_true')         ###根据data文件选择none
